/*
    ...
    Seleccionar un tipo y dependiendo del tipo
    mostrar la generación o region en el 
    otro filtro 
    https://pokeapi.co/api/v2/type/ 
    
    Para Buscar Pokemon
    Hacer un bucle por cada pokemon de la lista,
    buscar el atributo types y del tipo obtener
    la generación, estos dos atributos se deben
